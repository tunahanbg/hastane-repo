            ...
            if (katagoriler == null) {
                ...
                for (DegerlendirmeKatagori katagori : katagoriler) {
                    ...
                    if (Hasta.degerler.containsKey(katagori)) {
                        ...
                        System.out.println("\n"+katagori + " değerlendirme katagorisinin puan ortalama değeri : " + katagoriOrtalama+"\n");
                ...
                System.out.println("\n\nTüm katagorilerin puan ortalamalarının ortalama değeri : " + ortalamalarinOrtalamasi +  "\n\n");
                ...
                for (int i = 0; i < dereceler.length; i++){
                    if (dereceler[i] < sinirOrtalamalarinOrtalamasi){
                        System.out.println("\n\n" +DegerlendirmeKatagori.values()[i] +" Katagorisinin " +
                                dereceler[i] +" ortalama puanlı derecelendirmesi yetersizdir.\nAlanın geliştirilmesi gerekiyor\n\n");}
                }
            }
        }
    }
